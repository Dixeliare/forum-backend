package com.longdx.forum_backend.repository;
...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    // Find posts by topic
    Page<Post> findByTopic_IdOrderByCreatedAtDesc(Long topicId, Pageable pageable);

    // Find personal posts (community_id IS NULL) - CẦN @Query vì có điều kiện IS NULL
    ...
    // Find posts by viral score (for ranking algorithm) - CẦN @Query vì có điều kiện > 0
